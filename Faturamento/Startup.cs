    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<FaturamentoContext>(options =>
                    options.UseMySql(Configuration.GetConnectionString("FaturamentoContext"), builder =>
                    builder.MigrationsAssembly("Faturamento")));

            services.AddScoped<SeedingService>();
            services.AddScoped<DistribuidoraService>();
